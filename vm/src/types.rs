...
///
/// The binary arithmetic instructions pop two values of the stack and pushes the result of
/// adding/comparing/etc the values. 
...
pub enum Instruction {
    ...
    /// the stack just before the arguments. After the call is done the function all arguments are
    /// removed and the function is replaced by the result of the call.
    Call(VMIndex),
    ...
    /// and `upvars` upvariables poped from the top of the stack.
    MakeClosure {
